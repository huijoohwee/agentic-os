...
export function cmdHelp() {
  process.stdout.write(
    [
      ...
      '    agentic-os release-common publish [--message=<text>] [--title=<text>] [--body-file=<file>]  publish exact lane head and hand off integration',
      ...
      '    npm run successor -- <scope> [--write=<path[,path...]>]  continue only after a published lane needs a fix',
