...
The operator selected `huijoohwee.github.io` as the shared planning owner. The owner migration moves
the TODO contract, Kanban board, immutable records and validation together, with preserved source
...
reuses the existing lane path semantics and governance hashing. Keep planning in `huijoohwee.github.io`, common
