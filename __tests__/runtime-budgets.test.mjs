...
test('this repository is inside its own documentation budget', (t) => {
  ...
  assert.equal(total, 40_954, 'update this exact cost to expose every always-load byte delta');
...
test('this repository is inside its own module budget', () => {
  ...
  assert.equal(total, 13_450, 'update this exact cost to expose every source-line delta');
