...
| Start, release, or deploy work | [Start](docs/START-WORKFLOW.md), [release](docs/RELEASE-WORKFLOW.md), [deploy](guides/DEPLOY-WORKFLOW.md) |
...
| `huijoohwee.github.io` | Common authoring guidelines, semantic schemas and reusable planning validators | [Guidelines][guidelines], [schema map][guideline-map] |
