...
export function createAgentApiApp({
  ...
  return {
    ...
    agentSwarmQuery: agentSwarmHandlers.query,
    agentSwarmTrace: agentSwarmHandlers.trace,
    agentSwarmEvaluate: agentSwarmHandlers.evaluate,
    agentSwarmCompare: agentSwarmHandlers.compare,
