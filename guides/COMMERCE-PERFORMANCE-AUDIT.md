...
| P1 | Mirror `.well-known/runtime-readiness.json:4`, `scripts/runtime-readiness-projection.mjs:7-28` | Green mirror validation accepts legacy source `agentic-graph@1f7b529d42b0f0cff2c7cd749842fdfe51755bed` and Canvas `110ffba7397fc9e28d6f47bb8a4cb9abe581495b`. Current commerce deployment is unproven; use Graph's protected release/publisher. |
...
| Resolved in documentation consolidation | Former website stack document | Stale Canvas workflow guidance is reconciled with source-owned lifecycle commands in [the technology stack](./TECH-STACK.md#operator-journey-and-bounded-harness); the dated original remains linked there. |
